        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-5 text-sm text-slate-300">
              {telefon && (
                <a href={`tel:${telefon.replace(/\s/g, '')}`} className="external-link flex items-center gap-1.5 hover:text-white transition-colors">
              ...
              {e_mail && (
                <a href={`mailto:${e_mail}`} className="external-link flex items-center gap-1.5 hover:text-white transition-colors">
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
