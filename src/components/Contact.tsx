...
export function ContactSection({ acf }: ContactProps) {
  const { kontakt_text, vorname, nachname, e_mail, telefon, adresse, plz, ort } = acf;
  ...
  return (
    <section className="section-gray py-16 print-avoid" id="kontakt">
          ...
          <form onSubmit={handleSubmit} className="card p-8 space-y-5">
            <div>
              ...
              <input
                ...
                style={{ '--tw-ring-color': '#43C26E' } as React.CSSProperties}
              />
            </div>
            <div>
